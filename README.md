...
Because Tiến Lên has many local rule sets (Southern Tiến Lên, Northern variations, Big Two-style rules), this README gives a practical, common rule set but not an exhaustive rule book. If your group uses house rules, add them here.

Enjoy playing! If you'd like, I can add a rules.json or a quick-play example script for an automated or web implementation of the game in this repository.